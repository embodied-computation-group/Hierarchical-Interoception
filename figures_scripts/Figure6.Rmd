...
hierarchical_slope_fit <- readRDS(here::here("results","power analysis","Extracted","Hierarchical","slopemodel.rds"))
hierarchical_threshold_fit <- readRDS(here::here("results","power analysis","Extracted","Hierarchical","thresholdmodel.rds"))

simple_test_slope_fit <- readRDS(here::here("results","power analysis","Extracted","Psi","slopemodel.rds"))
simple_test_threshold_fit <- readRDS(here::here("results","power analysis","Extracted","Psi","thresholdmodel.rds"))

uncertainty_propagation_slope_fit <- readRDS(here::here("results","power analysis","Extracted","Psi","slopemodel.rds"))
uncertainty_propagation_threshold_fit <- readRDS(here::here("results","power analysis","Extracted","Psi","thresholdmodel.rds"))

hierarchical_data <- read_csv(here::here("results","power analysis","Extracted","Hierarchical","df.csv")) %>% 
  mutate(test_type='h')

simple_test_data <- read_csv(here::here("results","power analysis","Extracted","Psi","df.csv")) %>% 
  mutate(test_type='s')

uncertainty_propagation_data <- read_csv(here::here("results","power analysis","Extracted","Psi_un","df.csv")) %>% 
  mutate(test_type='u')
