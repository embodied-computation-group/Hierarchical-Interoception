...
combined %>% 
  ...
  geom_abline(aes(intercept = 0,slope=1))+
  geom_linerange(aes(x=simulated_values,ymin=q5,ymax=q95,color=dataset))+
  geom_text(aes(x=25,y=-60+20*as.numeric(dataset=='gaussian'),label=sprintf("%.2f [%.2f - %.2f]",round(recovery_rate,2),round(lb,2),round(ub,2)),color=dataset))+
  theme_minimal()+
  scale_color_manual(values = c('#0072B2','#E69F00'))+
  theme(legend.position = 'none')+
  xlab('Ground truth')+
...
combined %>% 
  ...
  geom_abline(aes(intercept = 0,slope=1))+
  geom_linerange(aes(x=simulated_values,ymin=q5,ymax=q95,color=dataset))+
  geom_text(aes(x=3,y=7+0.7*as.numeric(dataset=='gaussian'),label=sprintf("%.2f [%.2f - %.2f]",round(recovery_rate,2),round(lb,2),round(ub,2)),color=dataset))+
  theme_minimal()+
  scale_color_manual(values = c('#0072B2','#E69F00'))+
  theme(legend.position = 'none')+
  xlab('Ground truth')+
...
combined %>% 
  ...
  geom_abline(aes(intercept = 0,slope=1))+
  geom_linerange(aes(x=simulated_values,ymin=q5,ymax=q95,color=dataset))+
  geom_text(aes(x=0.15,y=0.45+0.05*as.numeric(dataset=='gaussian'),label=sprintf("%.2f [%.2f - %.2f]",round(recovery_rate,2),round(lb,2),round(ub,2)),color=dataset))+
  theme_minimal()+
  scale_color_manual(values = c('#0072B2','#E69F00'))+
  theme(legend.position = 'none')+
  xlab('Ground truth')+
