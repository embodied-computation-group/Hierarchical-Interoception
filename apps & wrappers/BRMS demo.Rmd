...
*Note: This might take some time. To reduce run time, consider commenting out one of the calls to the brm function.*
...
In the case of our simulated data, alpha changes but not beta and the spread is therefore different between the conditions. We can compute the spread difference based on the parameters used to simulate the data (in arbitrary occlusion units):
