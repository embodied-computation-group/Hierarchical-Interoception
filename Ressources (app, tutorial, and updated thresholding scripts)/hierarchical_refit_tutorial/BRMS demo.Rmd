...
Here we want to see that the number of divergences for each chain is 0 that the low_energy is FALSE for all chains and the max_treedepth is below what we set when running the model. 
